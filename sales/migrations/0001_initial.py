    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Completed', 'Completed'), ('Proforma', 'Pro-forma'), ('Partially Refunded', 'Partially Refunded'), ('Refunded', 'Refunded')], default='Completed', max_length=20)),
